...
**Note:** Support for lrtemplate, costyle, and nksc formats has been removed. Historical mapping tables for those formats are preserved below for reference but are no longer active in the codebase.
...
- Guide future format additions
- Support CLI/TUI/Web warning messages
