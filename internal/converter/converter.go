...
// Supported conversions: All format pairs (6 conversion paths total)
//
// Parameters:
//   - input: Raw bytes of the source format file
//   - from: Source format identifier ("np3", "xmp", or "lrtemplate"). Use empty string for auto-detection.
//   - to: Target format identifier ("np3", "xmp", or "lrtemplate")
//
// Returns:
...
//   - XMP: XML structure + "crs:*" namespace (Camera Raw Settings)
//   - lrtemplate: Lua table syntax ("s = {")
//
// Returns:
//   - string: Detected format identifier ("np3", "xmp", or "lrtemplate")
...
func DetectFormat(input []byte) (string, error) {
	...
	// Check for lrtemplate: Lua table syntax
...
// Returns an error if the format is not one of: "np3", "xmp", "lrtemplate"
