...
<div class="relative w-full aspect-square bg-canvas-base border border-border rounded overflow-hidden select-none max-w-[400px] mx-auto">
	<!-- Grid Background -->
