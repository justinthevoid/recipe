...
<section class="flex flex-col">
	<button
		type="button"
		class="flex items-center gap-2 border-l-2 border-interactive pl-3 py-2 hover:bg-surface-hover rounded-r transition-colors cursor-pointer w-full text-left"
